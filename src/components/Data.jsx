...
function Data() {
    ...
    return (
        <div>
            ...
            <input type="text" placeholder='enter title' name='title' ref={title} />

            {/* <!-- Button trigger modal --> */}
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={handlesubmit}>
                Add
            </button>
